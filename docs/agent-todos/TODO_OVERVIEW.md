...
kanban
  ...
  doing[Doing]
    ...
    plugin-agent-todos-0003[Add Skill `/todo-creation`]@{ ticket: plugin-agent-todos-0003 }
    plugin-agent-todos-0004[improve import skill]@{ ticket: plugin-agent-todos-0004 }
    plugin-agent-todos-0005[Add TODO_OVERVIEW.md and /todo-overview skill]@{ ticket: plugin-agent-todos-0005 }
    plugin-agent-todos-0006[Visusalisation in Overview]@{ ticket: plugin-agent-todos-0006 }
    plugin-agent-todos-0007[add link to overview]@{ ticket: plugin-agent-todos-0007 }
